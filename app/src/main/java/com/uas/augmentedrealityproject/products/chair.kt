...
@Composable
fun ChairProduct(navController: NavController, cartViewModel: CartViewModel) {
    val productId = 2
    ...
    val recommendedProducts = productList.filter { it.first != "chair" }.shuffled().take(3)
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                // Placeholder Image
                Image(
                    painter = painterResource(id = R.drawable.mo_chair),
...
@Composable
fun ChairProductPreview() {
    ChairProduct(navController = rememberNavController(), cartViewModel = viewModel())
}
