...
@Composable
fun StoolProduct(navController: NavController, cartViewModel: CartViewModel) {
    val productId = 4
    ...
    val recommendedProducts = productList.filter { it.first != "stool" }.shuffled().take(3)
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                // Placeholder Image
                Image(
                    painter = painterResource(id = R.drawable.mo_stool),
...
@Composable
fun StoolProductPreview() {
    StoolProduct(navController = rememberNavController(), cartViewModel = viewModel())
}
