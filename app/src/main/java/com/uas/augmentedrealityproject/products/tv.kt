...
@Composable
fun TVProduct(navController: NavController, cartViewModel: CartViewModel) {
    val productId = 6
    ...
    val recommendedProducts = productList.filter { it.first != "tv" }.shuffled().take(3)
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                // Placeholder Image
                Image(
                    painter = painterResource(id = R.drawable.mo_tv),
                ...
                // Product Info
                Column {
                    Text("TV", style = MaterialTheme.typography.headlineSmall)
                    Text("Entertainment In Front Of You! \nRp.6.500.000", style = MaterialTheme.typography.bodyMedium)
...
@Composable
fun TVProductPreview() {
    TVProduct(navController = rememberNavController(), cartViewModel = viewModel())
}
